...
//  Sapor
//
//  Created by Luke Hyungi Lee on 2023-03-20.
//
...
class PaymentHandler: NSObject {
	...
	func shippingMethodCalculator() -> [PKShippingMethod] {
		...
		let shippingEnd = calendar.date(byAdding: .day, value: 0, to: today)
		...
		if let shippingEnd = shippingEnd, let shippingStart = shippingStart {
			...
			shippingDelivery.detail = "Foods sent to your address"
	...
	func startPayment(products: [BasketItem], total: Double, completion: @escaping PaymentCompletionHandler) {
		...
		paymentRequest.merchantIdentifier = "merchant.group22.food"
